...
public class Controller {
    ...
    public interface FlashCardRepository extends JpaRepository<Flash_card, Integer> {

    }

    public interface FlashCardSetRepository extends JpaRepository<Flash_card_set, Integer> {
    ...
    public List<String> getFlashCardContentByUserID(List<Flash_card> flashCards,
        ...
        if (user != null) {
            ...
            if (subscription != null) {
                for (Flash_card_set flash_card_set : flashCardSets) {
                    ...
                    // Loop flash cards
                    for (Flash_card flash_card : flashCards) {
